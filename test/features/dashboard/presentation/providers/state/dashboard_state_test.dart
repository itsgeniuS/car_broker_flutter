  ...
  group('DashboardState Test\n', () {
    ...
    test('Should return valid String', () {
      ...
      expect(
        ...
        'DashboardState(isLoading:${dashboardState
            .isLoading}, productLength: ${dashboardState.productList
            .length},total:${dashboardState.total} page: ${dashboardState
            .page}, hasData: ${dashboardState.hasData}, state: ${dashboardState
            .state}, message: ${dashboardState.message})',
      );
    });
  });
}
